# Data Analyst Agent
# A comprehensive agent that can analyze documents, answer questions, and create visualizations
...
class DataAnalystAgent:
    ...
    def export_analysis_report(self) -> str:
        ...
        if self.conversation_history:
            report += "## Q&A History\n"
            for i, qa in enumerate(self.conversation_history[-5:], 1):  # Last 5 Q&As
                report += f"### Question {i}\n**Q**: {qa['question']}\n**A**: {qa['answer']}\n\n"
...
def main():
    ...
    st.markdown("*Powered by Llama-4-Maverick-17B-128E-Instruct-FP8*")
    ...
    with st.sidebar:
        ...
        api_key = st.text_input(
            "Together.ai API Key",
            type="password",
            help="Get your free API key from together.ai"
        )
        ...
        if uploaded_file and st.session_state.agent:
            ...
            with st.spinner("Processing document..."):
                ...
                st.write("Debug - Load result:", result)  # Debug info
    ...
    # Main content area
    if not api_key:
        st.warning("⚠️ Please enter your Together.ai API key in the sidebar to get started.")
        st.markdown("""
        ### How to get started:
        1. Sign up at [together.ai](https://www.together.ai/) for free API access
        2. Get your API key from the dashboard
        3. Enter the API key in the sidebar
        4. Upload your document (CSV, Excel, PDF, Word, Text, or Image)
    ...
    with tab2:
        ...
        if st.session_state.agent.current_data is None:
            ...
            # Still allow some analysis for text documents
            ...
            if st.button("🔄 Run Comprehensive Analysis"):
                with st.spinner("Analyzing data..."):
                    ...
                    st.write("Debug - Analysis results:", st.session_state.analysis_results)  # Debug info
